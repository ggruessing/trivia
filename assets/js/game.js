var quiz = [
	...
	["Which word is spelled incorrectly?","Liquefy","Inoculate","Sacreligious","C"],
	["Person A, B, and C are in a straight line wearing either a black or white hat.<br>There is at least 1 white and 1 black hat.<br>They do not know the color of their own hat, only the hat color of those in front of them.<br>The order is as such.<br><br>(front)A-B-C(back)<br><br>After a minute, one of the persons shouts out their hat color.<br>Which person is it?","A","B","C","B"],
		...
		if ((time===0)&&(noTime===false)){
			...
			$('button').on('click', function() {
            	...
            	if ($(this).text().trim()===quiz[counter-2][4]){
					...
					$(".quiz").html("OH NO! The anwser is: " +quiz[counter-2][4]+"<br>Next Question in:")
